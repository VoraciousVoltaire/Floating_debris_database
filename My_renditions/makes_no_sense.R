# The last resort- preparing this script because I want to check if the reason for discrepancy between our results is because they have just
# taken the first animal's vud 
...
dir_kernels <- paste0(getwd(), "/renditions_output/last_resort")
...
for(i in unique(relevant_new_data_2$colony)){
  sub <- relevant_new_data_2 %>% filter(colony == i)
  ...
  setwd("/Users/ameydanole/Desktop/ENS_Rennes/argh/Microplastic_ingestion_by_fulmarus_glacialis/1_full_analysis_petrels/renditions_output/last_resort/")
...
setwd("/Users/ameydanole/Desktop/ENS_Rennes/argh/Microplastic_ingestion_by_fulmarus_glacialis/1_full_analysis_petrels/input_data/fulmars_project_data/last_resort_data/")
dir_1by1 <- ("/Users/ameydanole/Desktop/ENS_Rennes/argh/Microplastic_ingestion_by_fulmarus_glacialis/1_full_analysis_petrels/renditions_output/last_resort/")
...
dir_demClasses <- "/Users/ameydanole/Desktop/ENS_Rennes/argh/Microplastic_ingestion_by_fulmarus_glacialis/1_full_analysis_petrels/input_data/fulmars_project_data/last_resort_data/colony_rasters/"
